        ...
        <div className="sm:md:flex justify-evenly gap-20 items-center py-20">
          ...
          <div className="w-full md:w-1/2">
            <div>
              ...
              <p className="mt-8">
                Our kits provide hands-on experiments, interactive activities,
                and educational resources to explore scientific concepts and
                engineering principles. They promote critical thinking,
                problem-solving, and a deep understanding of STEM subjects.
              </p>
            ...
            <div className="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-light-blue-300 duration-300  card  bg-gradient-to-r from-primary to-secondary text-neutral-content">
              <div className=" p-4 items-center text-left">
                ...
                <p className=" text-white">
                  ...
                  learning and ignite a passion for scientific discovery.{" "}
                </p>
              </div>
            </div>
            <div className="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-light-blue-300 duration-300  card  bg-gradient-to-r from-primary to-secondary text-neutral-content">
              <div className=" p-4 items-center text-left">
                ...
                <p className="text-white">
                  ...
                  quality.We believe in the power of education to transform
                  lives. Our kits are meticulously designed to provide valuable
                  learning.
                </p>
              </div>
            </div>
